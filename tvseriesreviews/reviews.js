...
var robot = new Review(
    ...
    '8.6/10',
    '9.5/10',
    'Follows Elliot, a young programmer working as a\n' +
    'cyber-security engineer by day, and a vigilante hacker by night.',

    'A really good tv series easily in my top 5 of tv series that I have\n' +
...
var breaking = new Review(
    ...
    'Breaking bad had been mentioned to me a few times before I decided to watch this top tv series\n' +
...
var narcos = new Review(
    ...
    '8.9/10',
    '10/10',
    'A chronicled look at the criminal exploits of Colombian drug lord Pablo Escobar, as well as\n' +
    'the many other drug kingpins who plagued the country through the years.',
...
var orange = new Review(
    ...
    '9.3/10',
    '9/10',
    'Convicted of a decade old crime of transporting drug money to an ex-girlfriend, normally\n' +
    'law abiding Piper Chapman is sentenced to a year and a half behind bars to face\n' +
...
var power = new Review(
    ...
    '8.2/10',
    '9/10',
    'James "Ghost" St. Patrick, a wealthy New York night club owner who\n' +
    'has it all, catering for the city\'s elite and\n' +
    'dreaming big, lives a double life as a drug kingpin.',
